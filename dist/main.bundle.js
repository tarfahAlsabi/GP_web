        ...
        if (this.selectedValue != undefined) {
            if (this.startDate && this.endDate) {
                if (this.startDate <= this.endDate) {
                    ...
                    this.flashMensaje.show('لا يجب ان يسبق تاريخ  النهاية تاريخ البداية.', { cssClass: 'alert-danger', timeout: 100000,
                        closeOnClick: true, showCloseBtn: true });
                }
            }
            else {
                this.flashMensaje.show('يجب عليك ادخال الفترة الزمنية أولا.', { cssClass: 'alert-danger', timeout: 100000,
                    closeOnClick: true, showCloseBtn: true });
            }
        }
        else {
            this.flashMensaje.show('الرجاء إختيار موظف', { cssClass: 'alert-danger', timeout: 5000 });
        }
    };
...
var EmployeeSalesComponent = /** @class */ (function () {
    ...
    EmployeeSalesComponent.prototype.changeProduct = function () {
        if (this.selectedValue != undefined) {
            ...
            this.flashMensaje.show('الرجاء إختيار منتج', { cssClass: 'alert-danger', timeout: 100000,
                closeOnClick: true, showCloseBtn: true });
        }
    };
    ...
    EmployeeSalesComponent.prototype.getEmployeeSales = function () {
        ...
        this.firebase.list(window.name + '/receipts', function (query) {
            ...
            for (var _i = 0, list_1 = list; _i < list_1.length; _i++) {
                ...
                if (date[0] < _this.startDate.getFullYear() || date[0] > _this.endDate.getFullYear() ||
                    date[1] < _this.startDate.getUTCMonth() + 1 || date[1] > _this.endDate.getUTCMonth() + 1 ||
                    date[2] < _this.startDate.getDate() || date[2] > _this.endDate.getDate()) {
                    continue;
                }
                var q = 0;
            ...
            if (_this.error)
                _this.flashMensaje.show('لا يوجد للموظف مبيعات في الفترة المحدةة.', { cssClass: 'alert-danger', timeout: 5000 });
            _this.creatChart();
        });
...
var SalesReportComponent = /** @class */ (function () {
    function SalesReportComponent(reportsService, firebase, flashMensaje) {
        ...
        this.firebase = firebase;
        this.flashMensaje = flashMensaje;
        this.chart = __WEBPACK_IMPORTED_MODULE_5_chart_js__["Chart"];
        this.hasDate = true;
        this.hasSelection = false;
        this.reportName = 'تقرير المبيعات ';
        this.tableheader = ['التصنيف', 'الكمية المباعة', 'الربح'];
        this.temp = new __WEBPACK_IMPORTED_MODULE_2__shared_receipt_model__["a" /* InnerProduct */];
        this.startDate = new Date();
        this.endDate = new Date();
        this.displayedColumns = ['name', 'quantity', 'price', 'cost', 'totalIncome'];
        this.dataSource = new __WEBPACK_IMPORTED_MODULE_6__angular_material__["J" /* MatTableDataSource */](new Array());
    }
    ...
    SalesReportComponent.prototype.creatChart = function () {
        ...
        this.chart = new __WEBPACK_IMPORTED_MODULE_5_chart_js__["Chart"]('pie', {
            type: 'bar',
            data: {
                labels: label,
                datasets: [{
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_6__angular_material__["G" /* MatSort */]),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_6__angular_material__["G" /* MatSort */])
    ], SalesReportComponent.prototype, "sort", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_6__angular_material__["u" /* MatPaginator */]),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_6__angular_material__["u" /* MatPaginator */])
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.register = function (email, password, username, firstName, lastName, phone, salary, picPATH, picName) {
        try {
...
var EmployeeService = /** @class */ (function () {
    ...
    EmployeeService.prototype.insert = function (employee, path, fileName) {
        ...
        //this.temp='1';
        var x = this.authService.register(employee.email, employee.password, employee.username, employee.firstName, employee.lastName, employee.phone, employee.salary, employee.picPATH, employee.picName);
...
var FinanceComponent = /** @class */ (function () {
    function FinanceComponent(fb, flashMensaje) {
        this.fb = fb;
        this.flashMensaje = flashMensaje;
    ...
    FinanceComponent.prototype.ngOnInit = function () {
        console.log(__WEBPACK_IMPORTED_MODULE_2_firebase_app__["database"]().ref(window.name + 'manager').child('xFinance'));
        //console.log('pass')
    };
    FinanceComponent.prototype.onSubmit = function (financeForm) {
        ...
        if (!this.finance.bank && !this.finance.box) {
            this.flashMensaje.show('(أرجو إدخال أحد الأصول المتداول على الأقل (الصندوق,البنك.', { cssClass: 'alert-danger', timeout: 100000,
                closeOnClick: true, showCloseBtn: true });
        }
        else {
...
module.exports = "<flash-messages></flash-messages>\n<div class=\"Mycontainer\">\n<div class=\"spacer\">\n  \n  <div class=\"container contactform center\">\n  <h2 class=\"text-center  wowload fadeInUp\"> تسجيل الدخول</h2>\n    <div class=\"row wowload fadeInLeftBig\">      \n        <div class=\"col-sm-6 col-sm-offset-3 col-xs-12\">      \n          <input type=\"text\" [(ngModel)]=\"emailLog\" name=\"emailLog\" placeholder=\"البريد الإلكتروني\"\n           pattern=\"^\\w+([\\.-]?\\w+)*@\\w+([\\.-]?\\w+)*(\\.\\w{2,3})+$\" required>\n\n           <div *ngIf=\"emailLog.errors && (emailLog.dirty || emailLog.touched)\"  class=\"alert alert-danger\">\n            <div [hidden]=\"!emailLog.errors.required\">*ارجو إدخال البريد الإلكتروني</div>\n            <div [hidden]=\"!emailLog.errors.pattern\">*فورمات البريد الإلكتروني غير صحيحة</div>\n           </div>\n\n          <input type=\"password\" [(ngModel)]=\"passwordLog\" name=\"passwordLog\" placeholder=\"الرقم السري\" \n          minlength=\"8\" required>\n\n          <div *ngIf=\"passwordLog.errors && (passwordLog.dirty || passwordLog.touched)\"  class=\"alert alert-danger\">\n            <div [hidden]=\"!passwordLog.errors.required\">*ارجو إدخال كلمة السر</div>\n            <div [hidden]=\"!passwordLog.errors.minlength\">*كلمة السر يجب أن لا تقل عن 8 خانات</div>\n           </div>\n\n          <button class=\"btn btn-primary\" (click)=\"loginTestFirst()\"> تأكيد</button>\n        </div>\n    </div></div></div>\n\n  </div>"
...
var LogInComponent = /** @class */ (function () {
    ...
    LogInComponent.prototype.loginTestFirst = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_5_firebase__["database"]().ref().on('value', function (snap) {
            ...
            console.log(result);
            for (var k in result) {
                if (result[k].manager.email == _this.emailLog) {
    ...
    LogInComponent.prototype.onSubmitLogin = function () {
        ...
        this.authService.loginEmail(this.emailLog, this.passwordLog)
            ...
            _this.flashMensaje.show('عملية تسجيل الدخول غير صحيحة, أرجو التأكد من البيانات.', { cssClass: 'alert-danger', timeout: 5000 });
            _this.router.navigate(['']);
        });
    };
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(route, router, dialog, authService, flashMensaje) {
        this.route = route;
        this.router = router;
        this.dialog = dialog;
        this.authService = authService;
    ...
    RegisterComponent.prototype.addFileThenRegistuer = function () {
        var _this = this;
        if (this.selectedFiles) {
            var file_1 = this.selectedFiles.item(0);
            var storageRef = __WEBPACK_IMPORTED_MODULE_5_firebase__["storage"]().ref(file_1.name);
            var uploadTask_1 = storageRef.put(file_1);
            uploadTask_1.on(__WEBPACK_IMPORTED_MODULE_5_firebase__["storage"].TaskEvent.STATE_CHANGED, function (snapshot) {
                // upload in progress
                ...
                // upload success
                _this.picPath = uploadTask_1.snapshot.downloadURL;
                _this.picName = file_1.name;
                _this.onSubmitAddUser();
            });
        }
        else {
    ...
    RegisterComponent.prototype.onSubmitAddUser = function () {
        ...
        this.authService.registerUser(this.email, this.password)
            .then(function (res) {
            window.name = _this.businessname;
            var ReceiptID = 0;
            if (_this.selectedFiles) {
                var file_2 = _this.selectedFiles.item(0);
                var storageRef = __WEBPACK_IMPORTED_MODULE_5_firebase__["storage"]().ref(file_2.name);
                var uploadTask_2 = storageRef.put(file_2);
                uploadTask_2.then(function (r) {
                    _this.picPath = uploadTask_2.snapshot.downloadURL;
                    _this.picName = file_2.name;
                    _this.authService.registerManager(ReceiptID, _this.email, _this.password, _this.fname, _this.lname, _this.phone, _this.businessname, _this.picName, _this.picPath, res.uid);
                }).catch(function (erorr) {
                    console.log('pic error');
                });
            }
            else {
                _this.picPath = 'https://firebasestorage.googleapis.com/v0/b/erad-system.appspot.com/o/defaultEmployee.jpg?alt=media&token=cb0d86a8-cea9-4f19-9177-d12d0a054b62';
                _this.picName = 'defaultEmployee.jpg';
                _this.authService.registerManager(ReceiptID, _this.email, _this.password, _this.fname, _this.lname, _this.phone, _this.businessname, _this.picName, _this.picPath, res.uid);
            }
            _this.router.navigate(['mainPage']);
        }).catch(function (err) {
            _this.flashMensaje.show('عملية تسجيل الدخول غير صحيحة, أرجو التأكد من ادخال جميع البيانات.', { cssClass: 'alert-danger', timeout: 5000 });
...
module.exports = "<div class=\"ViewsContainer\">\r\n        <div class=\"dialogTitle\">\r\n        <h1 mat-dialog-title> حذف المشروع </h1>\r\n        <h4> هل أنت متأكد من حذف المشروع ؟ </h4>\r\n        <h5>  عند حذف للمشروع سيتم حذف جميع البيانات المتعلقة به و لن يمكنك استعادتها مجدداً</h5>\r\n      </div>\r\n        <div mat-dialog-actions class=\"DialogOptionBtn\">\r\n          \r\n          <button mat-button [mat-dialog-close]=\"yes\" cdkFocusInitial>تسريح </button>\r\n          <button mat-button [mat-dialog-close]=\"\"  >إلغاء الأمر </button>\r\n        </div>\r\n        \r\n        </div>"
...
var ManagerComponent = /** @class */ (function () {
    function ManagerComponent(firebase, db, router, flashMensaje, dialog) {
        this.firebase = firebase;
        this.db = db;
        this.router = router;
        this.flashMensaje = flashMensaje;
